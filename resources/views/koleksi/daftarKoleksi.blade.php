                              ...
                              <table class="min-w-full text-center text-sm font-light">
                                <thead class="border-b font-medium dark:border-neutral-500">
                                  <tr class="border-b border-indigo-200 bg-neutral-500 text-white">
                                    ...
                                    <th scope="col" class="whitespace-nowrap px-6 py-4">Nama Koleksi</th>
                                    <th scope="col" class="whitespace-nowrap px-6 py-4">Jenis Koleksi</th>
                                    <th scope="col" class="whitespace-nowrap px-6 py-4">Jumlah Koleksi</th>
